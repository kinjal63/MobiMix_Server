 ...
 */
@Entity
@Table(name="game_profile_time_details")
public class GameProfileTimeDetails implements Serializable {

    @Id
    @Column(name = "game_profile_time_id")
    ...
    @JsonIgnoreProperties("gameProfileTime")
    @ManyToOne
